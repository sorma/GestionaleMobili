        ...
        <div className={styles.overviewGrid}>
          <div className={styles.statCard}>
            ...
            <div>
              ...
              <p className={styles.statMeta}>Numero totale attualmente registrato</p>
            </div>
          </div>
          ...
          <div className={styles.statCard}>
            ...
            <div>
              ...
              <p className={styles.statMeta}>Interventi e visite pianificati per oggi</p>
            </div>
          </div>
          ...
          <div className={styles.statCard}>
            ...
            <div>
              ...
              <h3 className={styles.statValueSmall}>
                {nextAppointment
                  ? formatItDateTime(nextAppointment.data_ora || nextAppointment.start_at)
                  : "Nessuno"}
              </h3>
          ...
          <div className={styles.panel}>
            ...
            <div className={styles.tableWrap}>
              <table className={styles.table}>
                ...
                <tbody>
                  {rows.map((r) => {
                    const status = getAppointmentStatus(r.data_ora || r.start_at);
