  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(`Errore nella creazione del cliente: ${errorData.error || 'Impossibile creare il cliente.'}`);
      }
    } catch (error) {
